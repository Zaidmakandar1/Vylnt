...
const arbFindingType = fc.constantFrom("missing_header", "misconfigured_header", "insecure_cookie", "mixed_content", "dom_pattern", "cve", "note");
...
const arbMLFilterStatus = fc.constantFrom("applied", "unavailable", "not_applicable");
const arbScanReport = fc.record({
...
describe("Property 11: Scan Report serialization round-trip", () => {
    it("JSON.parse(JSON.stringify(report)) deeply equals the original report", () => {
        fc.assert(fc.property(arbScanReport, (report) => {
...
//# sourceMappingURL=builder.roundtrip.test.js.map