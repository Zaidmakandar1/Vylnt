...
describe("inspectCookies", () => {
    ...
    describe("missing Secure on HTTPS", () => {
        it("produces a finding when Secure is absent on HTTPS page", () => {
            ...
            const secureFinding = findings.find((f) => f.description.toLowerCase().includes("secure") && f.description.includes("session"));
    ...
    describe("missing HttpOnly", () => {
        it("produces a finding when HttpOnly is absent", () => {
            ...
            const httpOnlyFinding = findings.find((f) => f.description.toLowerCase().includes("httponly") && f.description.includes("session"));
        ...
        it("finding description includes the cookie name", () => {
            ...
            const httpOnlyFinding = findings.find((f) => f.description.toLowerCase().includes("httponly"));
            expect(httpOnlyFinding).toBeDefined();
    ...
    describe("SameSite=None without Secure", () => {
        it("produces a high-severity finding", () => {
            ...
            const sameSiteFinding = findings.find((f) => f.severity === "high" && f.details?.detectedSameSite === "None");
    ...
    describe("HTTP page — Secure check skipped", () => {
        it("does not produce a Secure finding on HTTP page", () => {
            ...
            const secureFinding = findings.find((f) => f.description.toLowerCase().includes("https page") ||
